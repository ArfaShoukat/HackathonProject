...
//     const donorSubscription = supabase
...
//           fetchDonors(); // Re-fetch updated list
//         }
//       )
//       .subscribe();

//     return () => {
//       supabase.removeChannel(donorSubscription);
//     };
//   }, []);
...
import React, { useEffect, useState } from 'react';
import { supabase } from '../config/Supabase'; // update path if needed
import {
  PieChart, Pie, Cell,
  BarChart, Bar, XAxis, YAxis, Tooltip,
  ResponsiveContainer
